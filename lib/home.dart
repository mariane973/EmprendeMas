...
import 'package:EmprendeMas/vistas/principales/productosCategoria.dart';
            ...
            children: [
              Expanded(
                  child: GestureDetector(
                      onTap: (){
                        Navigator.push(context,
                            MaterialPageRoute(builder: (context) => ProductosCategoria(categoriaSeleccionada: 'Accesorios')));
                      },
                      child: Padding(
              ...
              Expanded(
                  child: GestureDetector(
                      onTap: (){
                        Navigator.push(context,
                            MaterialPageRoute(builder: (context) => ProductosCategoria(categoriaSeleccionada: 'Comida'))
                        );
                      },
                      child: Padding(
            ...
            children: [
              Expanded(
                  child: GestureDetector(
                      onTap: (){
                        Navigator.push(context,
                            MaterialPageRoute(builder: (context) => ProductosCategoria(categoriaSeleccionada: 'Ropa'))
                        );
                      },
                      child: Padding(
                          padding: const EdgeInsets.only(top: 20, left: 20, right: 10),
              ...
              Expanded(
                  child: GestureDetector(
                      onTap: (){
                        Navigator.push(context,
                            MaterialPageRoute(builder: (context) => ProductosCategoria(categoriaSeleccionada: 'Artesanías'))
                        );
                      },
                      child: Padding(
                          padding: const EdgeInsets.only(top: 20, left: 10, right: 20),
            ...
            children: [
              Expanded(
                  child: GestureDetector(
                      onTap: (){
                        Navigator.push(context,
                            MaterialPageRoute(builder: (context) => ProductosCategoria(categoriaSeleccionada: 'Plantas'))
                        );
                      },
                      child: Padding(
                          padding: const EdgeInsets.only(top: 20, left: 20, right: 10),
              ...
              Expanded(
                  child: GestureDetector(
                      onTap: (){
                        Navigator.push(context,
                            MaterialPageRoute(builder: (context) => ProductosCategoria(categoriaSeleccionada: 'Cuidado Personal'))
                        );
                      },
                      child: Padding(
                          padding: const EdgeInsets.only(top: 20, left: 10, right: 20),
            ...
            children: [
                  ...
                  child: GestureDetector(
                      onTap: () async {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => DatosServicios(serviciosData: serviciosData),
                          ),
                        );
                      },
                      child: Padding(
              ...
              Expanded(
                  child: GestureDetector(
                      onTap: (){
                        Navigator.push(context,
                            MaterialPageRoute(builder: (context) => ProductosCategoria(categoriaSeleccionada: 'Venta de Garaje'))
                        );
                      },
                      child: Padding(
                          padding: const EdgeInsets.only(top: 20, left: 10, right: 20),
