...
class ServiciosOferta extends StatefulWidget {
  const ServiciosOferta({super.key});

  @override
  State<ServiciosOferta> createState() => _ServiciosOfertaState();
}


class _ServiciosOfertaState extends State<ServiciosOferta> {
  ...
  void _filtradoOferta() async {
    ...
    for (var vendedorDoc in vendedoresSnapshot.docs) {
      ...
      for (var servicioDoc in serviciosSnapshot.docs) {
        allResults.add(servicioDoc.data());
      }
    }
    setState(() {
