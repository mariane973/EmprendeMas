...
class ServiciosC extends StatefulWidget {
  final List<Map<String, dynamic>> serviciosData;
  final String correo;

  const ServiciosC({required this.correo, required this.serviciosData});

  @override
  State<ServiciosC> createState() => _ServiciosCState();
}

class _ServiciosCState extends State<ServiciosC> {
  List _resultados = [];
                              ...
                              Stack(
                                children:[
                                  Container(
                                    ...
                                    child: ClipRRect(
                                      borderRadius: BorderRadius.circular(18),
                                      child: servicioData['imagen'] != null
                                          ? Image.network(
                                        servicioData['imagen'],
                                        fit: BoxFit.cover,
                                      )
